...
export const TEAM_B_C_FETCH = 'data/TEAM_B_C_FETCH'
export const TEAM_B_C_FETCH_SUCCESS = 'data/TEAM_B_C_FETCH_SUCCESS'
export const TEAM_B_C_FETCH_ERROR = 'data/TEAM_B_C_FETCH_ERROR'
export const TEAM_B_C_FETCH_FAILURE = 'data/TEAM_B_C_FETCH_FAILURE'

export const getTeamBC = createAction(TEAM_B_C_FETCH)
...
export default handleActions({
  [TEAM_B_C_FETCH]: (state) => ({
    ...state,
    data: null,
    isLoading: true,
    isError: false
  }),
  [TEAM_B_C_FETCH_SUCCESS]: (state, { payload }) => {
    return ({
      ...state,
      data: {
        inOut: {
  ...
  [TEAM_B_C_FETCH_ERROR]: (state) => ({
    ...state,
    data: null,
    isLoading: false,
    isError: true
  }),
  [TEAM_B_C_FETCH_FAILURE]: (state) => ({
    ...state,
    data: null,
    isLoading: false,
    isError: true
