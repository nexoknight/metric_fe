...
export const ERRORS_BERCUT_WITH_OTHERS_FETCH = 'data/ERRORS_BERCUT_WITH_OTHERS_FETCH'
export const ERRORS_BERCUT_WITH_OTHERS_FETCH_SUCCESS = 'data/ERRORS_BERCUT_WITH_OTHERS_FETCH_SUCCESS'
export const ERRORS_BERCUT_WITH_OTHERS_FETCH_ERROR = 'data/ERRORS_BERCUT_WITH_OTHERS_FETCH_ERROR'
export const ERRORS_BERCUT_WITH_OTHERS_FETCH_FAILURE = 'data/ERRORS_BERCUT_WITH_OTHERS_FETCH_FAILURE'

export const getErrorsBercutWithOther = createAction(ERRORS_BERCUT_WITH_OTHERS_FETCH)
...
export default handleActions({
  [ERRORS_BERCUT_WITH_OTHERS_FETCH]: (state) => ({
    ...state,
    data: null,
    isLoading: true,
    isError: false
  }),
  [ERRORS_BERCUT_WITH_OTHERS_FETCH_SUCCESS]: (state, { payload }) => {
    return ({
      ...state,
      data: {
        inOut: {
  ...
  [ERRORS_BERCUT_WITH_OTHERS_FETCH_ERROR]: (state) => ({
    ...state,
    data: null,
    isLoading: false,
    isError: true
  }),
  [ERRORS_BERCUT_WITH_OTHERS_FETCH_FAILURE]: (state) => ({
    ...state,
    data: null,
    isLoading: false,
    isError: true
