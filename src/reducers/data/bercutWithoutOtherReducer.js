...
export const BERCUT_WITHOUT_OTHERS_FETCH = 'data/BERCUT_WITHOUT_OTHERS_FETCH'
export const BERCUT_WITHOUT_OTHERS_FETCH_SUCCESS = 'data/BERCUT_WITHOUT_OTHERS_FETCH_SUCCESS'
export const BERCUT_WITHOUT_OTHERS_FETCH_ERROR = 'data/BERCUT_WITHOUT_OTHERS_FETCH_ERROR'
export const BERCUT_WITHOUT_OTHERS_FETCH_FAILURE = 'data/BERCUT_WITHOUT_OTHERS_FETCH_FAILURE'

export const getBercutWithoutOther = createAction(BERCUT_WITHOUT_OTHERS_FETCH)
...
export default handleActions({
  [BERCUT_WITHOUT_OTHERS_FETCH]: (state) => ({
    ...state,
    data: null,
    isLoading: true,
    isError: false
  }),
  [BERCUT_WITHOUT_OTHERS_FETCH_SUCCESS]: (state, { payload }) => {
    return ({
      ...state,
      data: {
        inOut: {
  ...
  [BERCUT_WITHOUT_OTHERS_FETCH_ERROR]: (state) => ({
    ...state,
    data: null,
    isLoading: false,
    isError: true
  }),
  [BERCUT_WITHOUT_OTHERS_FETCH_FAILURE]: (state) => ({
    ...state,
    data: null,
    isLoading: false,
    isError: true
