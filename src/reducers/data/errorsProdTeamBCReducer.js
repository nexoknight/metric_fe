...
export const ERRORS_PROD_TEAM_B_C_FETCH = 'data/ERRORS_PROD_TEAM_B_C_FETCH'
export const ERRORS_PROD_TEAM_B_C_FETCH_SUCCESS = 'data/ERRORS_PROD_TEAM_B_C_FETCH_SUCCESS'
export const ERRORS_PROD_TEAM_B_C_FETCH_ERROR = 'data/ERRORS_PROD_TEAM_B_C_FETCH_ERROR'
export const ERRORS_PROD_TEAM_B_C_FETCH_FAILURE = 'data/ERRORS_PROD_TEAM_B_C_FETCH_FAILURE'

export const getErrorsProdTeamBC = createAction(ERRORS_PROD_TEAM_B_C_FETCH)
...
export default handleActions({
  [ERRORS_PROD_TEAM_B_C_FETCH]: (state) => ({
    ...state,
    data: null,
    isLoading: true,
    isError: false
  }),
  [ERRORS_PROD_TEAM_B_C_FETCH_SUCCESS]: (state, { payload }) => {
    return ({
      ...state,
      data: {
        inOut: {
  ...
  [ERRORS_PROD_TEAM_B_C_FETCH_ERROR]: (state) => ({
    ...state,
    data: null,
    isLoading: false,
    isError: true
  }),
  [ERRORS_PROD_TEAM_B_C_FETCH_FAILURE]: (state) => ({
    ...state,
    data: null,
    isLoading: false,
    isError: true
