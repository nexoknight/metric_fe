...
export const ALL_INTEGRATION_FETCH = 'data/ALL_INTEGRATION_FETCH'
export const ALL_INTEGRATION_FETCH_SUCCESS = 'data/ALL_INTEGRATION_FETCH_SUCCESS'
export const ALL_INTEGRATION_FETCH_ERROR = 'data/ALL_INTEGRATION_FETCH_ERROR'
export const ALL_INTEGRATION_FETCH_FAILURE = 'data/ALL_INTEGRATION_FETCH_FAILURE'

export const getAllIntegrationWithoutBilling = createAction(ALL_INTEGRATION_FETCH)
...
export default handleActions({
  [ALL_INTEGRATION_FETCH]: (state) => ({
    ...state,
    data: null,
    isLoading: true,
    isError: false
  }),
  [ALL_INTEGRATION_FETCH_SUCCESS]: (state, { payload }) => {
    return ({
      ...state,
      data: {
        inOut: {
  ...
  [ALL_INTEGRATION_FETCH_ERROR]: (state) => ({
    ...state,
    data: null,
    isLoading: false,
    isError: true
  }),
  [ALL_INTEGRATION_FETCH_FAILURE]: (state) => ({
    ...state,
    data: null,
    isLoading: false,
    isError: true
