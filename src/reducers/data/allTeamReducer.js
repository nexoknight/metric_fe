...
export const ALL_TEAM_FETCH = 'data/ALL_TEAM_FETCH'
export const ALL_TEAM_FETCH_SUCCESS = 'data/ALL_TEAM_FETCH_SUCCESS'
export const ALL_TEAM_FETCH_ERROR = 'data/ALL_TEAM_FETCH_ERROR'
export const ALL_TEAM_FETCH_FAILURE = 'data/ALL_TEAM_FETCH_FAILURE'

export const getAllTeam = createAction(ALL_TEAM_FETCH)
...
export default handleActions({
  [ALL_TEAM_FETCH]: (state) => ({
    ...state,
    data: null,
    isLoading: true,
    isError: false
  }),
  [ALL_TEAM_FETCH_SUCCESS]: (state, { payload }) => {
    return ({
      ...state,
      data: {
        inOut: {
  ...
  [ALL_TEAM_FETCH_ERROR]: (state) => ({
    ...state,
    data: null,
    isLoading: false,
    isError: true
  }),
  [ALL_TEAM_FETCH_FAILURE]: (state) => ({
    ...state,
    data: null,
    isLoading: false,
    isError: true
